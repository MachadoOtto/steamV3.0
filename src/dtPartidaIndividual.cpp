...
DtPartidaIndividual::DtPartidaIndividual(int id,DtFechaHora fecha,float duracion,bool activa,string h,string vj,int w): DtPartida(id,fecha,duracion,activa,h,vj) {
    idPartidaAnterior = w;
}
